...
def f(x, alpha=0.88):
	...
	Returns        77 line me objective function hai
	-------
...
# Perform optimization.  kitni cost lag rhi hai. har iteration ke saath kam ho rhi hai cost (cost kam hogi to optimise hoga) 
